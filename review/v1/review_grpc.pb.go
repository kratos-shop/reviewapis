...
const (
	...
	Review_OperationAppealReview_FullMethodName = "/api.review.v1.Review/OperationAppealReview"
)
...
type ReviewClient interface {
	...
	// 运营申诉评价
	OperationAppealReview(ctx context.Context, in *OperationAppealReviewRequest, opts ...grpc.CallOption) (*OperationAppealReviewReply, error)
}
...
func (c *reviewClient) OperationAppealReview(ctx context.Context, in *OperationAppealReviewRequest, opts ...grpc.CallOption) (*OperationAppealReviewReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(OperationAppealReviewReply)
	err := c.cc.Invoke(ctx, Review_OperationAppealReview_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ReviewServer interface {
	...
	// 运营申诉评价
	OperationAppealReview(context.Context, *OperationAppealReviewRequest) (*OperationAppealReviewReply, error)
...
func (UnimplementedReviewServer) OperationAppealReview(context.Context, *OperationAppealReviewRequest) (*OperationAppealReviewReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method OperationAppealReview not implemented")
}
...
func _Review_OperationAppealReview_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(OperationAppealReviewRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ReviewServer).OperationAppealReview(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Review_OperationAppealReview_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ReviewServer).OperationAppealReview(ctx, req.(*OperationAppealReviewRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Review_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "OperationAppealReview",
			Handler:    _Review_OperationAppealReview_Handler,
		},
	},
